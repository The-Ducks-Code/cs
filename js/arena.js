Arena = function(game) {
    ...
    materialGround.diffuseTexture = new BABYLON.Texture("../assets/images/texture-1504364_640.jpg", scene);
    ...
    materialWall.diffuseTexture = new BABYLON.Texture("../assets/images/pexels-hoang-le-978503.jpg", scene);
